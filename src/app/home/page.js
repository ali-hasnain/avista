    ...
    <div>
      ...
      <div className={`row ${styles.heplusBanner}`}>
        <span className={`text-center ${styles.fontsize}`}>
          Help Us `{"<->"}` Help <span style={{ color: "#73A133" }}>You</span>
        </span>
        <span
          style={{ color: "#73A133", fontSize: "25px", textAlign: "center" }}
        >
          Align our subject matter experts with your needs
        </span>
        <div className="d-flex justify-content-center my-5">
          <div
            style={{
              border: "2px solid #73A133",
              height: "25px",
              width: "25px",
              borderRadius: "50%",
              margin: "10px 10px",
              backgroundColor: "#73A133",
            }}
          ></div>
          <div
            style={{
      ...
      {step == 0 && (
        ...
        >
          {industryContent.map((industry, index) => (
            <div
              key={index}
              className={` btn ${styles.bannerCard} `}
              onMouseEnter={() => setBannerCard(industry.id)}
              onMouseLeave={() => setBannerCard(0)}
              onClick={() => setStep(1)}
            >
              <div
              ...
              >
                ...
                <img
                  src={industry?.img2}
                  className="py-2"
                  hidden={bannerCard != industry.id}
                />
              </div>
              <div className="text-center mx-auto">{industry?.content}</div>
            </div>
          ))}
        </div>
      )}
      {step == 1 && (
        ...
        >
          {banner2.map((industry, ind) => (
            <div
              key={ind}
              onClick={() => setStep(2)}
              className={`btn ${styles.bannerCard2}`}
            >
              {industry}
            </div>
          ))}
      ...
      {step == 2 && (
        <div>
          ...
          >
            ...
            >
              For clients hoping to achieve an overarching vision, or those
      ...
      <div className={`${styles.introduceBanner2} text-center`}>
        <div>
          <div className="" style={{ margin: "60px" }}>
            <h2
              style={{ color: "black", fontSize: "80px", fontWeight: "bolder" }}
            >
              Multishore
            </h2>
          </div>
          ...
          >
            HIRING MULTISHORE TALENT HAS NEVER BEEN THIS EASY!
          </p>
          <div>
      ...
      <div className={`row ${styles.heplusBanner}`}>
        <span className={`text-center ${styles.fontsize}`}>
          Our Latest <span style={{ color: "#73A133" }}>Insights</span>
        </span>
        <span
          style={{ color: "#73A133", fontSize: "25px", textAlign: "center" }}
        >
        ...
        <Slider {...setting2}>
          <div className={`px-3 ${sliderIndex != 3 && "py-5"}`}>
            <div
              ...
              style={{ width: sliderIndex != 3 ? "22rem" : "20rem" }}
            >
              <img
                className="card-img-top"
                src="/Globalization.jpg"
                alt="Card image cap"
              />
              <div className="card-body">
                ...
                >
                  Globalization Challenges for Japanese Multinationals
                </h5>
                {sliderIndex == 3 && (
                  <p className="card-text">
                    The rise of globalization has presented both opportunities
                    and challenges..
                  </p>
                )}
                {sliderIndex == 3 && (
          ...
          <div className={`px-3 ${sliderIndex != 0 && "py-5"}`}>
            <div
              className="card shadow"
              style={{ width: sliderIndex != 0 ? "22rem" : "20rem" }}
            >
              <img
                className="card-img-top"
                src="Futuristic.jpg"
              ...
              <div className="card-body">
                ...
                >
                  How Futuristic Technology would Help the Newer Generation
                </h5>
                {sliderIndex == 0 && (
                  <p className="card-text">
                    The world is rapidly changing, and so is technology. Every..
                  </p>
                )}
                {sliderIndex == 0 && (
                  <a href="#" className={styles.button2}>
          ...
          <div className={`px-3 ${sliderIndex != 1 && "py-5"}`}>
            <div
              className="card shadow"
              style={{ width: sliderIndex != 1 ? "22rem" : "20rem" }}
            >
              <img
                className="card-img-top"
                src="Group.jpg"
          ...
          <div className={`px-3 ${sliderIndex != 2 && "py-5"}`}>
            <div
              className="card shadow"
              style={{ width: sliderIndex != 2 ? "22rem" : "20rem" }}
            >
              <img
                className="card-img-top"
                src="Technology.jpg"
              ...
              <div className="card-body">
                ...
                >
                  Technology Played a Critical Role in the Covid-19 Pandemic
                  Response
                </h5>
                {sliderIndex == 2 && (
                  <p className="card-text">
                    The Covid-19 pandemic has been a challenging time for the..
                  </p>
                )}
                {sliderIndex == 2 && (
                  <a href="#" className={styles.button2}>
