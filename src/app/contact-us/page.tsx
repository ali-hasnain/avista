    ...
    <div>
      ...
      <div className="row p-3">
        <div className="col-lg-6 p-5">
          <span style={{ fontSize: "55px", fontWeight: "bolder" }}>
            {" "}
            <span style={{ color: "#73A133" }}>Our </span>
            Offices
          </span>
          {card.map((item, index) => (
        ...
        <div className="col-lg-6 pt-5 form-group">
          <form>
            <h3 style={{ fontWeight: "bolder" }}>
              Fill out the details below for one of our experts to get in touch
              with you.
            </h3>
            <div className="row">
              <div className="col-lg-6">
                <input
                  ...
                  className="form-control p-3 m-3 border border-primary"
                ></input>
                <input
                  type="email"
                  placeholder="Email"
            ...
            <button
              className={`p-3 m-3 border border-primary ${styles.button}`}
            >
              Submit
            </button>
          </form>
